...
public class FtpUtil {
    ...
    public static void main(String[] args) {
        String ftpHost = "152.136.192.202";
        String ftpUserName = "ftpuser";
        String ftpPassword = "123654";
        int ftpPort = 5011;
        String ftpPath = "/data/app/ftp/";
        ...
        try{
            ...
            FtpUtil.downloadFtpFile(ftpHost, ftpUserName, ftpPassword, ftpPort, ftpPath, "E:\\", "123.text", "123.text");
        } catch (Exception e){
            e.printStackTrace();
